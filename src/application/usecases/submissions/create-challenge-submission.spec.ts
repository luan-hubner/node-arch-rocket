...
describe("Create challenge submission use case", () => {
  ...
  it("shouldn't be able to create a new challenge submission if student doesn't exists.", async () => {
    const studentsRepository = new InMemoryStudentsRepository();
    const challengesRepository = new InMemoryChallengesRepository();
    ...
    ).rejects.toThrow("Student doesn't exists.");
  });
  ...
  it("shouldn't be able to create a new challenge submission if challenge doesn't exists.", async () => {
    ...
    ).rejects.toThrow("Challenge doesn't exists.");
  });
});
